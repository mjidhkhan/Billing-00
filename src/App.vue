  ...
  <div id="app" class="antialiased text-gray-800">
    ...
    <div class=" flex bg-white overflow-hidden  lg:max-w-full ">
      ...
      <div class="px-8 py-12 max-w-md mx-auto sm:max-w-xl 
        ...
        <div class="xl:max-w-lg xl:ml-auto">
            ...
            <h1 class="mt-6 text-lg font-bold text-gray-800 leading-tight  
        ...
        <div class="hidden lg:block lg:w-1/2 lg:relative 
                    sm:bg-gray-100 lg:bg-primary-200 ">
    ...
    <div class="max-auto ">
        <div class="bg-gray-100 pb-12 border-gray-200 border-solid border-t">
          ...
          <p class="text-gray-600 px-8">A selection of great work-friendly cities with lots to see and explore.</p>
    ...
    <div class="max-auto ">
      <div class="bg-gray-100 pb-12 border-gray-200 border-solid border-t">
        <h2 class="text-xl text-gray-800 px-8">Rentials</h2>
        <p class="text-gray-600 px-8">Available to rent at any time.</p>
      </div>
      <div class="flex flex-wrap pb-12">
          <div class=" items-center justify-center mt-6 w-full 
                        px-4 sm:w-1/2 lg:w-1/2 xl:w-1/4 "  
...
import PropertyData from './store/PropertiesData'
...
export default {
  ...
  data() {
    return {
            destinations:PropertyData.PropertyData.popularDestinations ,
            properties:PropertyData.PropertyData.popularProperties ,
      }
  }
}
